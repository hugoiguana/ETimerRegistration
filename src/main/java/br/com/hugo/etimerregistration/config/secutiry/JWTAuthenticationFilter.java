...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws AuthenticationException {
        try {
            AuthenticationEmployeeDTO creds = new ObjectMapper().readValue(req.getInputStream(), AuthenticationEmployeeDTO.class);

            UsernamePasswordAuthenticationToken authToken
                    = new UsernamePasswordAuthenticationToken(creds.getPis(), creds.getPassword(), new ArrayList<>());
    ...
    private class JWTAuthenticationFailureHandler implements AuthenticationFailureHandler {
        ...
        private String json() {
            ...
            json.append("\"message\": \"Pis ou senha inválidos\", ");
